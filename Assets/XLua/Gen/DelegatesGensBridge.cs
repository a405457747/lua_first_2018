...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp17(XLua.LuaTable p0, UnityEngine.EventSystems.PointerEventData p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp18(XLua.LuaTable p0, UnityEngine.Collider2D p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp19(XLua.LuaTable p0, UnityEngine.Collision2D p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Action<XLua.LuaTable, UnityEngine.EventSystems.PointerEventData>))
			{
			    return new System.Action<XLua.LuaTable, UnityEngine.EventSystems.PointerEventData>(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(System.Action<XLua.LuaTable, UnityEngine.Collider2D>))
			{
			    return new System.Action<XLua.LuaTable, UnityEngine.Collider2D>(__Gen_Delegate_Imp18);
			}
		
		    if (type == typeof(System.Action<XLua.LuaTable, UnityEngine.Collision2D>))
			{
			    return new System.Action<XLua.LuaTable, UnityEngine.Collision2D>(__Gen_Delegate_Imp19);
			}
